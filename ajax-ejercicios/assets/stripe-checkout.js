...
let products, prices;
//para hacer peticiones de una API con varios endpoints, no importa el orden en que se incoquen las peticiones, se van a ir mapeando en el orden en que se coloque en el Promise.all()
