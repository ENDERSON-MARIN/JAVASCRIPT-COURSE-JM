...
/* DEFINICION: ES UN FORMATO LIGERO DE INTERCAMBIO DE DATOS, SE HA CONVERTIDO EN UN ESTANDAR, SE DENOTA MEDIANTE CLAVE VALOR Y DBEN TENER COMILLAS DOBLES */
/*     const json = {//objeto javascript
      cadena: "Jon",
      numero: 35,
      booleano: true,
    ...
    console.log(JSON.parse("{}"));//parse convierte una notacion json a un tipo de dato js
    ...
    console.log("*** JSON.stringify ***");//el inverso de parse convierte un tipo de dato js a JSON o cadena de texto
